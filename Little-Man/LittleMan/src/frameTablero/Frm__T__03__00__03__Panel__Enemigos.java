...
public class Frm__T__03__00__03__Panel__Enemigos extends JPanel implements ActualizableImagen{
	
	private static final long serialVersionUID = 1L;
	private Frm__T__04__00__03__Label__Enemigos[][] labels = new Frm__T__04__00__03__Label__Enemigos[T_CFG.COLUMNAS][T_CFG.FILAS];
	
	int cellSize = T_CFG.PXL_LADO;
	
    public Frm__T__03__00__03__Panel__Enemigos() {
    	setOpaque(false);
		setLayout(null);
				
		for (int columna = 0; columna < labels.length; columna++) {
			for (int fila = 0; fila < labels[columna].length; fila++) {
				labels[columna][fila] = new Frm__T__04__00__03__Label__Enemigos(40);
