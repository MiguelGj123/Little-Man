...
public class Frm__Powerup__Icon__Generator {
	private static Frm__Powerup__Icon__Generator factory;
	private Frm__Powerup__Icon__Generator() {}
	
	public static Frm__Powerup__Icon__Generator getFactory() {
		if (factory == null) factory = new Frm__Powerup__Icon__Generator();
		return factory;
	}
