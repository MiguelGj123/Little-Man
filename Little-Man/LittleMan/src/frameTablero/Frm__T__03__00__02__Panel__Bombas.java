...
public class Frm__T__03__00__02__Panel__Bombas extends JPanel implements ActualizableImagen{
	
	private static final long serialVersionUID = 1L;
	private Frm__T__04__00__02__Label__Bombas[][] labels = new Frm__T__04__00__02__Label__Bombas[T_CFG.COLUMNAS][T_CFG.FILAS];
	int cellSize = T_CFG.PXL_LADO;
	
    public Frm__T__03__00__02__Panel__Bombas() {
    	setOpaque(false);
		setLayout(null);
				
		for (int columna = 0; columna < labels.length; columna++) {
			for (int fila = 0; fila < labels[columna].length; fila++) {
				labels[columna][fila] = new Frm__T__04__00__02__Label__Bombas(30);
