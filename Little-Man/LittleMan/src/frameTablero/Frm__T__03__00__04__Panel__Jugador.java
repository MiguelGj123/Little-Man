...
public class Frm__T__03__00__04__Panel__Jugador extends JPanel implements ActualizableImagen{
	
	private static final long serialVersionUID = 1L;
	private Frm__T__04__00__04__Label__Jugador[][] labels = new Frm__T__04__00__04__Label__Jugador[T_CFG.COLUMNAS][T_CFG.FILAS];
	
	int cellSize = T_CFG.PXL_LADO;
	
    public Frm__T__03__00__04__Panel__Jugador() {
    	setOpaque(false);
		setLayout(null);
				
		for (int columna = 0; columna < labels.length; columna++) {
			for (int fila = 0; fila < labels[columna].length; fila++) {
				labels[columna][fila] = new Frm__T__04__00__04__Label__Jugador(200);
