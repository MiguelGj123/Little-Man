...
//Clase Singleton que gestiona los power-ups del juego: su aparición, recogida, efectos y visualización.
public class EscenarioPowerups {
 ...
 // Genera un power-up aleatorio en la posición indicada utilizando la fábrica correspondiente.
 ...
 // Verifica si el jugador recoge un power-up y aplica su efecto. Devuelve los puntos obtenidos.
 ...
 // Aplica el efecto correspondiente al tipo de power-up recogido, según su código.
 ...
 // Devuelve una matriz con la posición y tipo de cada power-up para su visualización en pantalla.
